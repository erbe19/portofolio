...
// CHANGE: foto grayscale → berwarna penuh saat hover
// ============================================================================
      ...
      <div className="max-w-6xl mx-auto w-full grid md:grid-cols-2 gap-12 items-center relative z-10">
        ...
        <div className="space-y-8 relative z-20">
          ...
          <p className="text-xl md:text-2xl max-w-lg leading-snug" style={{ color: "var(--text-secondary)" }}>
            Menciptakan{" "}
            <span className="font-bold" style={{ color: "var(--text-primary)" }}>Solusi Digital Cerdas</span>{" "}
            untuk{" "}
            <span className="font-bold" style={{ color: "var(--text-primary)" }}>Masa Depan</span>.
          </p>
          ...
          <div className="flex flex-wrap items-center gap-4">
            <button
              ...
              style={{
                ...
                boxShadow: "0 0 0 0 var(--shadow-accent)",
              }}
              onMouseEnter={(e) =>
                (e.currentTarget.style.boxShadow = "0 0 24px var(--shadow-accent)")}
              onMouseLeave={(e) =>
                (e.currentTarget.style.boxShadow = "0 0 0 0 var(--shadow-accent)")}
            >
        ...
        {/* Right: Photo — grayscale → color on hover */}
        <div className="relative flex justify-center items-center z-10">
          <div
            className="absolute inset-0 border border-dashed rounded-full animate-[spin_20s_linear_infinite] scale-110"
            style={{ borderColor: "var(--border)" }}
          />
          <div className="photo-frame relative w-full max-w-112.5 aspect-4/5 rounded-[4rem] overflow-hidden shadow-2xl rotate-2 hover:rotate-0 transition-transform duration-700"
            style={{ border: "1px solid var(--border)", background: "var(--bg-surface-alt)" }}
          >
            <img
              src="\images\rb.jpg"
              alt="Rizky Bachtiar"
              className="photo-img w-full h-full object-cover brightness-90 contrast-110 transition-all duration-700"
